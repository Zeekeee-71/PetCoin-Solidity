...
task("get-liquidity", "Show LP token balance and share of PETAI/WETH pool")
  .setAction(async (args, hre) => {
    ...
    const sharePetai = Math.floor(Number(reservePetai) * pct);
    ...
    console.log(`   ~${sharePetai/shareWeth} PETAI/WETH`);
  });
